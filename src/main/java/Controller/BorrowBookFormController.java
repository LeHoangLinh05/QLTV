...
public class BorrowBookFormController {
    ...
    public BorrowBookFormController(Library library, Member member) {
    ...
    public void initialize() {
        bookComboBox.getItems().addAll(library.getAvailableBooks()); // Lấy tất cả sách có sẵn từ thư viện
    }

    // Xử lý mượn sách khi nhấn nút "Borrow Book"
    @FXML
    public void borrowBook(ActionEvent event) {
        Book selectedBook = bookComboBox.getValue(); // Sách được chọn
